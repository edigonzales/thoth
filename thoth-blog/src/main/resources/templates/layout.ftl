...
<head>
  ...
  <script src="/assets/prism/components/prism-groovy.min.js" defer></script>
  <script src="/assets/prism/components/prism-gradle.min.js" defer></script>
  ...
  <script src="/assets/prism/components/prism-ilimap.js" defer></script>
...
<body<#if pageClass?has_content> class="${pageClass?html}"</#if>>
  ...
  <main id="content"<#if pageClass?has_content> class="${pageClass?html}"</#if>>
    <#nested>
  </main>
</body>
</html>
